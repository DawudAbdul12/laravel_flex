                    ...
                    <div class="row items-push">
                        ...
                        <div class="col-sm-5 text-right hidden-xs">
                            <ol class="breadcrumb push-10-t">
                                <li>Testimonials</li>
                                <li><a class="link-effect" href="/admin/testimonial/create">Add </a></li>
                            </ol>
                        </div>
                    </div>
                </div>
                            ...
                            <table class="table table-bordered table-striped js-dataTable-full">
                                ...
                                <?php  foreach ($testimonials as $key => $row) : ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <div class="btn-group">
                                                <a href="/admin/testimonial/{{ $row->id }}/edit" class="btn btn-xs btn-default" type="button" data-toggle="tooltip" title="Edit"><i class="fa fa-pencil"></i></a>
                                                {!! Form::open(['action' => ['testimonialController@destroy', $row->id ], 'method' => 'POST']) !!}
                                                {{ method_field('DELETE') }}
