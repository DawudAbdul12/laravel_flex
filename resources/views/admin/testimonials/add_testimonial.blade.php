...
@section('content')
                    ...
                    <div class="row items-push">
                        ...
                        <div class="col-sm-5 text-right hidden-xs">
                            <ol class="breadcrumb push-10-t">
                                <li>Add</li>
                                <li><a class="link-effect" href="/admin/testimonials">All</a></li>
                            </ol>
                        </div>
                    </div>
                </div>
         ...
         <div class="block">              
            <div class="block-content">
                 ...
                 {!! Form::open(['action' => 'testimonialController@store', 'method' => 'POST','files' => true,'class'=> 'form-horizontal push-10-t'] ) !!}
                                        
                     <div class="form-group">
                       <label class="col-xs-12" for="example-text-input">Full Name</label>
                        <div class="col-sm-12">
