                ...
                <div id="sidebar-scroll">
                    ...
                    <div class="sidebar-content">
                        ...
                        <ul class="nav-main">
                                ...
                                <li <?php if($page == "all_testimonials" || $page == "add_testimonial" ){?> class="open" <?php }?> >
                                    <a class="nav-submenu" data-toggle="nav-submenu" href="#"><i class="si si-calendar"></i><span class="sidebar-mini-hide"> Testimonials</span></a>
                                    <ul>
                                            <li>
                                              <a href="/admin/testimonial" <?php if($page == "all_testimonials"){?> class="active"<?php }?> > All  </a>
                                            </li>
                                            <li>
                                              <a href="/admin/testimonial/create" <?php if($page == "add_testimonial" || $page == "edit_testimonial"){?> class="active"<?php }?> >Add new</a>
                                            </li>
                                    </ul>
                                </li>
