      ...
      <div class="container-fluid container-who">
        <div class="row">
          <div class="col-12 mt-4">
            <img src="img/topcover.jpg" class="img-fluid topcoverimage" alt="">
          </div>

          <div class="col-12 tctext">
            <h1 class="mb-3">It’s a lifestyle and <br>
            Not a temporary fix</h1>
            <p>Lorem ipsum dolor sit amet, consectetur <br> adipiscing elit maecenas convallis.</p>

            <a href="#" class="btn btn-success">View Plans</a>
          </div>
        </div>
      </div>
    </section>
        ...
        <div class="container-fluid container-who2">
          <div class="row">
            <div class="col-12 col-md-5">
                ...
                <h2 class="my-3">How wholesome Craft Works <br> what you’ll get</h2>
                <p >The one-on-one consultation with  <br> our dietitian includes:</p>
    ...
    <section class="">
        <div class="container-fluid container-who2">
          <div class="row centerit">
            ...
            <div class="col-12 col-md-5 pl-md-5">
              <img src="img/petal.svg" class="img-fluid" width="40" alt="">
              <h2 class="my-4">What Our Customers <br>  Are Saying About Us</h2>
