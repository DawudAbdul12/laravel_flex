...
class productCOntroller extends Controller
{
    ...
    {
        $page = "add_product";
        return view('admin.product.add_product',compact('page'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return view('admin.product.add_product',compact('success','page'));
    ...
    public function edit($id)
    {
        ...
        $page = "edit_product";
        return view('admin.product.edit_product', compact('product','images','page'));
    }
    ...
    public function update(Request $request, $id)
    {
       ...
       return view('admin.product.edit_product',compact('product','images','success','page'));
